...
stacked$lib <- factor(stacked$lib, levels = c("Phage", "Non-Endemic", "Tbg", "Tbg Neg", "Tbr", "Tbr Neg"))
...
pheatmap_color <- colorRampPalette(brewer.pal(n=11, name = "RdBu"))(50)
pheatmap(round(chisq_res$residuals, 2), 
         cluster_rows = F,
         cluster_cols = F,
         col = pheatmap_color
         )
