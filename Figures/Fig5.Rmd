...
plot_grid(
  data.frame(ROC = tbg1_metrics, method = rep("GLM", 5000)) %>% 
  ggplot(aes(x = ROC)) + 
  ...
  ggtitle("GLM"),
  data.frame(ROC = tbg2_metrics, method = rep("Boost", 5000)) %>% 
  ggplot(aes(x = ROC)) + 
  geom_histogram(fill = "#1177BB", color = "black") + 
  ...
  scale_x_continuous(limits = c(0,1)) +
  ggtitle("Boost"),
  data.frame(ROC = tbg3_metrics, method = rep("MARS", 5000)) %>% 
  ggplot(aes(x = ROC)) + 
  geom_histogram(fill = "#1177BB", color = "black") + 
